...
docker build -t vguillaume/lets-exercise
docker build -t vguillaume/lets-exercise-client

# Push them to docker hub
echo "Pushing docker images"
docker push vguillaume/lets-exercise
docker push vguillaume/lets-exercise-client